    ...
    async function addUser() {
        ...
        if (user) {
            ...
            try {
                ...
                if(dat.exists()){
                    const getData = dat.data();
                    setUserType(getData?.gender || '');
                    setAge(getData?.age || '');
                    setBP(getData?.bloodPressure || '');
                    setDiabetic(getData?.diabetic || '');
                    setWt(getData?.weight || '');
                    setHt(getData?.height || '');
                    setBloodType(getData?.bloodType || '');
                // console.log('Update')
                // setAlert(true);
                }
            } catch (e) {
